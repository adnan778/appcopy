...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{asset('logincss')}}/fonts/font-awesome-4.7.0/css/font-awesome.min.css">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css"
        href="{{asset('logincss')}}/fonts/iconic/css/material-design-iconic-font.min.css">
    <!--===============================================================================================-->
        ...
        <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
            ...
            <form class="login100-form validate-form" method="POST" action="{{ route('updatePassword') }}">
                ...
                <div class="wrap-input100 validate-input m-b-20" data-validate="Enter old password">
                    <input class="input100 @error('oldpassword') is-invalid @enderror" type="password"
                ...
                <div class="wrap-input100 validate-input m-b-20" data-validate="Enter new password">
                    <input class="input100 @error('newpassword') is-invalid @enderror" type="password"
                ...
                <div class="wrap-input100 validate-input m-b-25" data-validate="Enter confirm password">
                    <input class="input100 @error('confirmpassword') is-invalid @enderror" type="password"
