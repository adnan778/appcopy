                            ...
                            <div class="card-header border-bottom text-center">
                                <div class="mb-3 mx-auto">
                                    <a href="{{route('changeProfilePicture')}}">
                                        <img id="picture" class="rounded-circle" src="/uimg/{{$users->image}}"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-lg-6">
                                                        ...
                                                        <input type="text" class="form-control" name="name"
                                                            id="feFirstName" placeholder="Name"
                                                            value="{{$users->name}}">
                                                    </div>
                                                    <div class="form-group col-lg-6">
                                                        <label for="feLastName">Email</label>
                                                        <input type="email" class="form-control" name="email"
                                                            id="feLastName" placeholder="Email"
                                                            value="{{$users->email}}">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-lg-6">
                                                        ...
                                                        <input type="number" class="form-control" name="phone"
                                                            id="feEmailAddress" placeholder="Phone"
                                                            value="{{$users->phone}}">
                                                    </div>
                                                    <div class="form-group col-lg-6">

                                                        <label for="feInputState">Gander</label>
                                                        <select id="feInputState" value="{{$users->gander}}"
                                                            name="gander" class="form-control">
                                                            <option>Male</option>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-lg-6">
                                                        ...
                                                        <input type="date" class="form-control" name="date"
                                                            id="feInputAddress" value="{{$users->date}}"
                                                            placeholder="{{$users->date}}">
